...
export const emojiList: EmojiList = [
  ...
  [
    "cat-face",
    ["\u{1F63A}", "\u{1F638}", "\u{1F639}", "\u{1F63B}", "\u{1F63C}", "\u{1F63D}", "\u{1F640}", "\u{1F63F}", "\u{1F63E}"],
  ],
  ...
  [
    "sound",
    ["\u{1F507}", "\u{1F508}", "\u{1F509}", "\u{1F50A}", "\u{1F4E2}", "\u{1F4E3}", "\u{1F4EF}", "\u{1F514}", "\u{1F515}"],
  ],
  [
    "music",
    ["\u{1F3BC}", "\u{1F3B5}", "\u{1F3B6}", "\u{1F399}", "\u{1F39A}", "\u{1F39B}", "\u{1F3A4}", "\u{1F3A7}", "\u{1F4FB}"],
  ],
  [
    "musical-instrument",
    ["\u{1F3B7}", "\u{1FA97}", "\u{1F3B8}", "\u{1F3B9}", "\u{1F3BA}", "\u{1F3BB}", "\u{1FA95}", "\u{1F941}", "\u{1FA98}"],
  ],
